...
# =========================================================
DB_USERNAME = "minseonson7_db_user"
DB_PASSWORD = "sms478526"
ENCODED_PASSWORD = quote_plus(DB_PASSWORD)

URI = f"mongodb+srv://{DB_USERNAME}:{ENCODED_PASSWORD}@deproject1db.yoew6c3.mongodb.net/?appName=DEproject1DB"

client = MongoClient(URI)
db = client["DEproject1DB"]

restaurants_col = db["ex_Restaurants"]
reviews_col     = db["ex_Reviews"]
menus_col       = db["ex_Menus"]
...
def build_review_docs(raw, end_date=None):
    ...
    for r in reviews:
        ...
        doc = {
            ...
            "date":       created_dt,
            "visited_at": r.get("visited_at"),   # 실제 방문일
            "content":    content,                # 벡터 DB 활용 예정
            "author": {
                "nickname": author
            },
            "rating":          rating,
