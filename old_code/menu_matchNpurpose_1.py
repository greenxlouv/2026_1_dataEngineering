...
실행:
  python3 menu_matchNpurpose.py
  python3 menu_matchNpurpose.py --min-reviews 100 --workers 8 --sample 20
"""
...
def process_restaurant(args):
    restaurant_id, sample_mode = args
    kiwi = Kiwi()
...
def main():
    ...
    all_rows = []
    task_args = [(rid, sample_mode) for rid in all_ids]
