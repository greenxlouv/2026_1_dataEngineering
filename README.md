...
modeling.
• Key topics include data formats, generation, load, transformation,
data platforms, crawling, and annotation.
• In addition, projects using these technologies will be provided to
